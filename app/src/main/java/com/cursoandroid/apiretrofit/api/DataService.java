...
public interface DataService {
    ...
    //usar em caso de xml, perceba que os parâmetros são passados fora do objeto
    @FormUrlEncoded
    @POST("/posts")
    ...
    /*praticamente igual ao PUT. PUT atualiza todos os dados do objeto, já o PATCH
    troca somente os dados passados
     */
    @PATCH("/posts/{id}")
